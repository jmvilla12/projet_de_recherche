...
Item {
    ...
    Column {
        ...
        // Component for rendering the path generated by C++
        MapPolyline {
            id: finalPathLine
            line.width: 3
            line.color: "#00A651" // Green color from screenshot
            opacity: 1.0
        }
        ...
        MapQuickItem {
            ...
            anchorPoint.y: 10
            sourceItem: Rectangle {
                width: 20; height: 20; radius: 10; color: "#00A651"; border.color: "white"; border.width: 2
                Label { anchors.centerIn: parent; text: "D"; color: "white"; font.bold: true; font.pixelSize: 10 }
            }
        }
        ...
        MapQuickItem {
            ...
            sourceItem: Item {
                width: 20; height: 20
                Rectangle { width: 14; height: 3; color: "#FF0000"; rotation: 45; anchors.centerIn: parent; radius: 2 }
                Rectangle { width: 14; height: 3; color: "#FF0000"; rotation: -45; anchors.centerIn: parent; radius: 2 }
            }
        }
    }
